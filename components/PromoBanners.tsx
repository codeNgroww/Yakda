...
export default function PromoBanners({ onSelectCategory }: PromoBannersProps) {
  return (
    <section className="py-6 px-margin-mobile max-w-[1280px] mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        
        {/* Banner 1: Mega Stationery Sale */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#1A2A4E] to-[#16A2D4] p-6 text-white shadow-md flex flex-col justify-between min-h-[160px] group">
        ...
        {/* Banner 2: Back to School */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#F4B21B] to-[#D93630] p-6 text-white shadow-md flex flex-col justify-between min-h-[160px] group">
          <div className="relative z-10">
        ...
        {/* Banner 3: Workspace Upgrade */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#16A2D4] to-[#1A2A4E] p-6 text-white shadow-md flex flex-col justify-between min-h-[160px] group">
          <div className="relative z-10">
